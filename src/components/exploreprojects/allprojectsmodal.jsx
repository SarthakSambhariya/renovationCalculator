...
function AllProjectsModal({ name, modalName,review, exp, address, images, fee, pname, phoneNumber, projects=[], designerImage }) {
  // const [previouProject, setPreviouProject] = useState('');
  const [nextProject, setNextProject] = useState('');
 var temp = 1;
  function nextPage(){
    if(temp<=projects.length){
      setNextProject(projects[temp])
      temp++;
    }
  }
          ...
          <div className="modal-body">
                  ...
                  <div className="row justify-content-between">
                    <div className="col-lg-6 col-md-6 mb-80">
                      <div className="d-flex">
                        ...
                        <span className="fs-1 green-recon border-0" onClick={PreviousPage}>
                          ❮
                          </span>
                        </div>
                        <div>
                    ...
                    <div className="col-lg-6 col-md-6 mb-80">
                      <div className="d-flex">
                        ...
                        <div className="arrow" style={{cursor:"pointer"}}>
                        <span className="fs-1 green-recon border-0" onClick={nextPage}>
                          ❯
                        </span>
                        </div>
                      </div>
            ...
            <div className="row">
                ...
                <div className="">
                  ...
                  >
                    <div className="carousel-inner p-3 bg-secondary">
                      {nextProject 
                    ?
                     nextProject["data"][0]["images"].length > 0 ? (
                      nextProject["data"][0]["images"].map((m, i) => (
              ...
              <div className="col-lg-4 col-sm-12">
                <p>
                <span className="fs-4">
                {nextProject?nextProject.name:pname}l̥
                    {/* { name } */}
                  </span>
                  <FontAwesomeIcon
                    icon={heartO}
