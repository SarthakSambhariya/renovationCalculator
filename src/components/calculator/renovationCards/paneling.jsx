            ...
            <div className="col-md-9 shadow rounded">
              <div className="d-flex">
                ...
                {workSelectedCtx.selectedWorks.includes(
                  ...
                  <Link to="/paneling" style={{ margin: "0 4%" }}>
                    <p className="title">Partition and Panelling</p>
                  </Link>
                )}
              </div>
              <hr />
              <div className="row">
                ...
                <div className="col-md-5 d-flex justify-content-evenly ps-5">
                  <img
                    src="https://i.ibb.co/znfxxHN/Vector-10.png"
                    alt=""
                    style={icon}
                  />
                  <p style={leftText}>
                    Typically consists of woodwork on walls including
                    partitions, pelmets etc
                  </p>
                </div>
            ...
            <div className="col-md-9 shadow rounded">
              <div className="d-flex justify-content-between">
                ...
                {workSelectedCtx.selectedWorks.includes(
                  ...
                  <Link to="/paneling">
                    <p className="titleMob">Partition and Panelling</p>
                  </Link>
                )}
              </div>
